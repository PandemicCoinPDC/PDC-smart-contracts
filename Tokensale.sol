...
contract PrivateSale {
    ...
    uint256 public constant TOKEN_PRICE = 10; // Token price in stablecoin
    uint256 public constant TOKEN_ALLOCATION = 100; // Tokens per stablecoin
    
    // Addresses of supported stablecoins
    address public constant USDC_ADDRESS = 0xe6b8a5CF854791412c1f6EFC7CAf629f5Df1c747; // Replace with actual USDC contract address
    address public constant USDT_ADDRESS = 0xA02f6adc7926efeBBd59Fd43A84f4E0c0c91e832; // Replace with actual USDT contract address
    address public constant DAI_ADDRESS = 0xd393b1E02dA9831Ff419e22eA105aAe4c47E1253; // Replace with actual DAI contract address
    ...
    constructor(address _tokenAddress, uint256 _minBuyAmount, uint256 _maxBuyAmount) {
    ...
    function deposit(uint256 amount, address stablecoin) external saleIsOpen {
        require(stablecoin == USDC_ADDRESS || stablecoin == USDT_ADDRESS || stablecoin == DAI_ADDRESS, "Unsupported stablecoin");
        ...
        uint256 tokensToAllocate = amount * TOKEN_ALLOCATION / TOKEN_PRICE;
